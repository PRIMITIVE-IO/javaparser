...
public abstract class VoidVisitorAdapter<A> implements VoidVisitor<A> {
    ...
    public void visit(final ArrayCreationExpr n, final A arg) {
        ...
        for (ArrayCreationLevel p : n.getLevels()) {
            p.accept(this, arg);
        }
        n.getComment().ifPresent(l -> l.accept(this, arg));
    }
    ...
    public void visit(final BlockStmt n, final A arg) {
        for (Statement p : n.getStatements()) {
            p.accept(this, arg);
        }
        n.getComment().ifPresent(l -> l.accept(this, arg));
    }
    ...
    public void visit(final ClassOrInterfaceDeclaration n, final A arg) {
        for (ClassOrInterfaceType orInterfaceType : n.getExtendedTypes()) {
            orInterfaceType.accept(this, arg);
        }
    ...
    public void visit(final CompilationUnit n, final A arg) {
        ...
        for (TypeDeclaration<?> p : n.getTypes()) {
            p.accept(this, arg);
        }
        n.getComment().ifPresent(l -> l.accept(this, arg));
    }
    ...
    public void visit(final EnumConstantDeclaration n, final A arg) {
        ...
        for (BodyDeclaration<?> bodyDeclaration : n.getClassBody()) {
            bodyDeclaration.accept(this, arg);
        }
        n.getName().accept(this, arg);
        for (AnnotationExpr p : n.getAnnotations()) {
    ...
    public void visit(final ExplicitConstructorInvocationStmt n, final A arg) {
        for (Expression p : n.getArguments()) {
            p.accept(this, arg);
        }
    ...
    public void visit(final Parameter n, final A arg) {
        ...
        n.getName().accept(this, arg);
        n.getType().accept(this, arg);
        for (AnnotationExpr p : n.getVarArgsAnnotations()) {
            p.accept(this, arg);
        }
        n.getComment().ifPresent(l -> l.accept(this, arg));
    }
    ...
    public void visit(final IntersectionType n, final A arg) {
        for (ReferenceType referenceType : n.getElements()) {
            referenceType.accept(this, arg);
        }
        for (AnnotationExpr p : n.getAnnotations()) {
            p.accept(this, arg);
    ...
    public void visit(final SwitchEntry n, final A arg) {
        for (Expression expression : n.getLabels()) {
            expression.accept(this, arg);
        }
        for (Statement p : n.getStatements()) {
            p.accept(this, arg);
    ...
    public void visit(final SwitchStmt n, final A arg) {
        for (SwitchEntry p : n.getEntries()) {
            p.accept(this, arg);
        }
    ...
    public void visit(final TryStmt n, final A arg) {
        ...
        for (Expression p : n.getResources()) {
            p.accept(this, arg);
        }
    ...
    public void visit(final TypeParameter n, final A arg) {
        n.getName().accept(this, arg);
        for (ClassOrInterfaceType classOrInterfaceType : n.getTypeBound()) {
            classOrInterfaceType.accept(this, arg);
        }
        for (AnnotationExpr p : n.getAnnotations()) {
            p.accept(this, arg);
    ...
    public void visit(final ModuleDeclaration n, final A arg) {
        ...
        for (ModuleDirective p : n.getDirectives()) {
            p.accept(this, arg);
        }
        n.getName().accept(this, arg);
        n.getComment().ifPresent(l -> l.accept(this, arg));
